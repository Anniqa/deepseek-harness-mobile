...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fullscreen / edge-to-edge: transparent status bar, draw under the
        // display cutout (poni). LAYOUT_IN_DISPLAY_CUTOUT_MODE_SHORT_EDGES
        // needs API 28+; the classic layout flags work on every API level.
        Window w = getWindow();
